...
vnetShared000 = {
  ...
  # PEP
  subnet00 = {
    name         = "azrfrcsntpsyhsha0000"
    addressSpace = ["172.28.22.192/28"]
  }
  #container app env
  subnet01 = {
    name         = "azrfrcsntpsyhsha0001"
  ...
  pep = [
    {
      ...
      sourceAddressPrefix      = "172.28.22.224/27"
      destinationAddressPrefix = "172.28.22.192/28"
  ...
  cae = [
    {
      ...
      destinationAddressPrefix = "172.28.22.224/27"
